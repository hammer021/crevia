...
class _TentangFragmentState extends State<TentangFragment> {
  ...
  Future<void> _getAppVersion() async {
    ...
    setState(() {
      _appVersion =
          packageInfo.version; // Akan mengambil versi dari pubspec.yaml
      print("App version from pubspec.yaml: ${packageInfo.version}");
    });
  }
  ...
  Widget _buildStatus(BuildContext context) {
    return Container(
      ...
      child: Text(
        "\u00a9 Koperasi Konsumen Karyawan Pupuk Kaltim (KOPKAR PKT) ",
        style: TextStyle(
          fontFamily: 'Spectral',
          color: Colors.black,
          fontSize: 16.0,
  ...
  Widget _buildStatContainer() {
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          _buildStatItem("Versi", _appVersion),
        ],
      ),
    );
  }
